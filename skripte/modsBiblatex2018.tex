...
% Gleicher Abstand auch, wenn nur der Autorenname wechselt, der Anfangsbuchstabe
% aber gleich bleibt (z. B. Kessler -> Kurbel). Sonst stehen solche Einträge ohne
% Trennung direkt untereinander.
\setlength{\bibnamesep}{0.75cm}
