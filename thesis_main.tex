...
% Glossar
%-----------------------------------
% nonumberlist unterdrueckt die Fundstellenliste (Seitenzahlen) hinter jedem
% Eintrag. Ein Glossar erklaert Begriffe, es weist sie nicht nach; ohne die
% Zahlen entspricht es dem Abkuerzungsverzeichnis, das ebenfalls keine hat.
% Die Option muss hier stehen, da \printnoidxglossaries (Plural) selbst keine
% Optionen entgegennimmt.
...
%-----------------------------------
% Vorwort (optional; wird nicht verwendet)
% Bei Bedarf kapitel/vorwort/vorwort.tex anlegen, die beiden folgenden Zeilen
% entkommentieren und unter Inhaltsverzeichnis setcounter entsprechend anpassen.
%-----------------------------------
...
%-----------------------------------
% Die Arbeit enthält keine Abbildungen. Sobald welche hinzukommen, die beiden
% folgenden Zeilen wieder entkommentieren.
%\listoffigures
%\newpage
%-----------------------------------
% Tabellenverzeichnis
%-----------------------------------
% Die Arbeit enthält keine Tabellen. Sobald welche hinzukommen, die beiden
% folgenden Zeilen wieder entkommentieren.
%\listoftables
%\newpage
%-----------------------------------
...
% \phantomsection ist zwingend: acronyms.tex nutzt \section*, erzeugt also keinen
% Hyperref-Anker. Ohne den Befehl zeigt der Link im Inhaltsverzeichnis auf die
% Titelseite statt auf dieses Verzeichnis.
\phantomsection\addcontentsline{toc}{section}{\abbreHeadingName}
...
% dann folgende Zeile auskommentieren.
% Die Arbeit verwendet keine Formelsymbole. Sobald welche hinzukommen, die
% folgenden Zeilen wieder entkommentieren und in skripte/symbolDef.tex pflegen.
