...
%-----------------------------------
% 'printonlyused' entfernt: Das Abkürzungsverzeichnis wird direkt aus den in
% abkuerzungen/acronyms.tex definierten Einträgen gefüllt (alle dort gelisteten
% Abkürzungen werden im Text auch verwendet).
\usepackage{acronym}
...
%-----------------------------------
% Deaktiviert: Die Arbeit enthält keine Abbildungen, daher würde
% \listoffigures nur eine leere Seite erzeugen.
%\listoffigures
%\newpage
%-----------------------------------
% Tabellenverzeichnis
%-----------------------------------
% Deaktiviert: Die Arbeit enthält keine Tabellen, daher würde
% \listoftables nur eine leere Seite erzeugen.
%\listoftables
%\newpage
%-----------------------------------
% Abkürzungsverzeichnis
...
% \phantomsection setzt einen Hyperref-Anker an dieser Stelle, damit der Link im
% Inhaltsverzeichnis auf die Abkürzungsverzeichnis-Seite zeigt und nicht auf die
% erste Seite (\section* erzeugt selbst keinen Anker).
...
% dann folgende Zeile auskommentieren.
% Symbolverzeichnis deaktiviert: Die Arbeit verwendet keine Formelsymbole,
% daher würde \listofsymbols nur eine leere Seite erzeugen.
